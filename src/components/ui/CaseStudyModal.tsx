...
export default function CaseStudyModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal content */}
      <div className="relative w-full h-full overflow-y-auto bg-base-200">
        {/* Close button */}
        <button
          onClick={onClose}
          className="fixed top-4 right-4 z-10 btn btn-circle btn-ghost text-base-content hover:bg-base-300"
